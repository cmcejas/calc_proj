    ...
    return(
        <section>
            <div className="flex py-3 border-b-4 bg-slate-800 border-cyan-500 md:px-4">
                <Link href="/"><Image href="/" width={50} height={50} src={svg} alt="logo" className="ml-2 mr-2  drop-shadow-2xl md:mr-10 md:hover:scale-110 hover:-rotate-12 ease-in-out transition duration-200"/></Link>
